            ...
            <x-form wire:submit="register" no-separator class="space-y-4">
                ...
                <div class="space-y-1 relative" x-data="{ show: false }">
                    ...
                    <button type="button" @click="show = !show"
                        class="absolute right-4 bottom-3 text-slate-400 hover:text-[#A8894C] transition focus:outline-none">
                ...
                <div class="pt-4">
                    ...
                    <div class="pt-6 text-center">
                        <p class="text-slate-600 dark:text-slate-400 text-sm">
                            ...
                            <a href="{{ route('login') }}"
                                class="font-bold text-[#A8894C] hover:text-[#8C7132] transition-colors" wire:navigate>
                                Log in
                            </a>
                        </p>
                    </div>
