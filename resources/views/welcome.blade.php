    ...
    <header class="relative bg-slate-900 text-white overflow-hidden pb-20 lg:pb-32 pt-10">
        ...
        <nav class="relative z-10 container mx-auto px-6 lg:px-12 flex justify-between items-center h-16">
            ...
            <div class="flex gap-4 items-center">
                <a href="https://github.com/ekanata14/laravel-12-hybrid-action-oriented-template" target="_blank" class="text-slate-300 hover:text-white transition">GitHub</a>
        ...
        <div class="relative z-10 container mx-auto px-6 lg:px-12 mt-20 text-center max-w-4xl opacity-0 animate-fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://github.com/ekanata14/laravel-12-hybrid-action-oriented-template" target="_blank" class="px-8 py-4 rounded-xl bg-slate-800 border border-slate-700 font-bold hover:bg-slate-700 transition text-white flex items-center gap-2">
